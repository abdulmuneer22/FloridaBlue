...
export const _paymentsRequest = (state: Object) => state.merge({fetching: true, data: {}, error: null })
...
export const _paymentBarcodeRequest = (state: Object) => state.merge({fetching: true, data: {}, error: null })

...
const { Types, Creators } = createActions({
  memberRequest: [],
  memberSuccess: ['username', 'visibilityRules'],
  memberFailure: ['error']
})
...
export const success = (state: Object, {username, visibilityRules}: Object) =>
  state.merge({ fetching: false, error: null, username, visibilityRules})
